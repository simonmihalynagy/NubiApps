  ...
  return (
    <React.Fragment>
      <form className="flex flex-col items-center" onSubmit={submitHandler}>
        ...
        <input onChange={inputChangeHandler} type="text" name="duration" value={serviceData.duration} />
        <label>Cost</label>
        <input onChange={inputChangeHandler} type="text" name="cost" value={serviceData.cost} />
